...
Widget::Widget() {
    ...
    connect(texComboBox, SIGNAL(currentIndexChanged(
                                        const QString &)), m_pView, SLOT(changeTex(
                                                                                 const QString &)));
    connect(cubeMapComboBox, SIGNAL(currentIndexChanged(
                                            const QString &)), m_pView, SLOT(changeCubeMap(
                                                                                     const QString &)));
...
void Widget::loadTarget() {
    QString fileName = QFileDialog::getOpenFileName(this, tr("打开target文件"),
            ...
            //QString(tr("/home/cym/program/OBJ/ship/make_animation/output.target")),
                                                    QString(tr(
                                                            "/home/cym/program/make_obj/greek_vase/make_animation/output.target")),

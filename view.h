...
private:
	...
	int readShaderSource(const char *fileName, std::string &vertexShader, std::string &fragmentShader);
	bool installShaders(const GLchar *vertexShader, const GLchar *fragmentShader);

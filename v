...
smap ;cA <Plug>NERDCommenterAppend
nmap ;cA <Plug>NERDCommenterAppend
smap ;c$ <Plug>NERDCommenterToEOL
nmap ;c$ <Plug>NERDCommenterToEOL
smap ;cu <Plug>NERDCommenterUncomment
nmap ;cu <Plug>NERDCommenterUncomment
smap ;cn <Plug>NERDCommenterNest
nmap ;cn <Plug>NERDCommenterNest
smap ;cb <Plug>NERDCommenterAlignBoth
nmap ;cb <Plug>NERDCommenterAlignBoth
smap ;cl <Plug>NERDCommenterAlignLeft
nmap ;cl <Plug>NERDCommenterAlignLeft
smap ;cy <Plug>NERDCommenterYank
nmap ;cy <Plug>NERDCommenterYank
smap ;ci <Plug>NERDCommenterInvert
nmap ;ci <Plug>NERDCommenterInvert
smap ;cs <Plug>NERDCommenterSexy
nmap ;cs <Plug>NERDCommenterSexy
smap ;cm <Plug>NERDCommenterMinimal
nmap ;cm <Plug>NERDCommenterMinimal
smap ;c  <Plug>NERDCommenterToggle
nmap ;c  <Plug>NERDCommenterToggle
smap ;cc <Plug>NERDCommenterComment
nmap ;cc <Plug>NERDCommenterComment
nmap ;fl :NERDTreeToggle	" 打开NERDTree子窗口
nnoremap ;di :YcmDiags
nnoremap ;jd :YcmCompleter GoToDefinitionElseDeclaration
nnoremap ;tl :TagbarToggle
...
badd +752 widget.cc
badd +1020 view.cc
badd +1350 common_data.cc
badd +381 cuda_calc.cu
badd +1 v
badd +1 ~/program/pn/common_data.h
badd +32 obj_data.h
badd +1 main.cc
badd +1 Makefile
badd +1 build/Makefile
badd +1 build/1.pro
badd +1 ~/program/pn/view.h
badd +1 affd.fs
badd +1 affd_line.fs
badd +1 ~/program/make_obj/sphere/1.cc
badd +1 ~/program/pn/obj_data.cc
badd +176 matrix_stack.cc
badd +1 ~/program/pn/matrix_stack.h
badd +1 widget.h
badd +1 ~/arch_config.mkd
badd +1 affd.vs
badd +21 affd_line.vs
badd +1 affd_truth.fs
badd +46 affd_truth.vs
badd +0 affd_linevs
argglobal
silent! argdel *
argadd widget.cc
set lines=50 columns=186
set stal=2
edit widget.h
...
exe 'vert 1resize ' . ((&columns * 78 + 93) / 186)
exe 'vert 2resize ' . ((&columns * 107 + 93) / 186)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 63 - ((23 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
63
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 2024 - ((23 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
2024
...
exe 'vert 1resize ' . ((&columns * 78 + 93) / 186)
exe 'vert 2resize ' . ((&columns * 107 + 93) / 186)
tabedit ~/program/pn/common_data.h
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 2339 - ((19 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
2339
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 2845 - ((22 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
2845
